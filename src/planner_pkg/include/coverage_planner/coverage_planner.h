...
class CoveragePlanner{
    public:
        ...
        int naiveLawnmowerPlan(simple_drone_sim::Plan& plan);
    ...
    private:
        ...
        void planToNearestUnvisited(int x, int y, std::list<simple_drone_sim::Waypoint>& segment);

        void updateCoverageFromPose(int x, int y);

        void updateCoverageFromSegment(const std::list<simple_drone_sim::Waypoint>& segment);
