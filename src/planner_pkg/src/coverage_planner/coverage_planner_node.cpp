...
void CoveragePlannerNode::Run()
{
    ...
    plan_publisher = nh.advertise<simple_drone_sim::Plan>("/planning/global", 1, true);
    ros::spinOnce(); 
...
void CoveragePlannerNode::ObstacleHandler(const simple_drone_sim::ObstacleArrayConstPtr& msg)
{
...
void CoveragePlannerNode::OdometryHandler(const simple_drone_sim::PoseStampedArray::ConstPtr& msg)
{
