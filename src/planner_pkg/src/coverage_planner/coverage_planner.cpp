...
void CoveragePlanner::updateCoverageFromSegment(const std::list<simple_drone_sim::Waypoint>& segment)
{
...
void CoveragePlanner::planToNearestUnvisited(int x, int y, std::list<simple_drone_sim::Waypoint>& segment)
{
...
int CoveragePlanner::naiveLawnmowerPlan(simple_drone_sim::Plan& plan)
{
    plan.plan.clear();
    // go to map corner
    simple_drone_sim::Waypoint wp;
